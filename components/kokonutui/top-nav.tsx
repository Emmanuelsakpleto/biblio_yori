...
export default function TopNav() {
  const breadcrumbs: BreadcrumbItem[] = [
    { label: "ECC Alumni Plateforme", href: "#" },
  ...
  return (
    <nav className="h-full px-3 sm:px-6 flex items-center justify-between bg-white dark:bg-[#0F0F12] border-b border-gray-200 dark:border-[#1F1F23]">
      ...
      </div>      <div className="flex items-center gap-2 sm:gap-4 ml-auto sm:ml-0">
        <ThemeToggle />
        <DropdownMenu>
          <DropdownMenuTrigger className="focus:outline-none">
            <Image
              src="https://api.dicebear.com/7.x/bottts/svg?seed=alumni"
              alt="User avatar"
              width={28}
              height={28}
